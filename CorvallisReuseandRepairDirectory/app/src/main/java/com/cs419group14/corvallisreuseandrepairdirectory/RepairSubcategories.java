...
public class RepairSubcategories extends ListActivity {
    ...
    private static final String URL_CATEGORIES = "http://web.engr.oregonstate.edu/~izunot/CS419/android/categories_subcategories.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            alert.showAlertDialog(RepairSubcategories.this, "Internet Connection Error",
    ...
    class LoadBusinesses extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RepairSubcategories.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            RepairSubcategories.this, businessList,

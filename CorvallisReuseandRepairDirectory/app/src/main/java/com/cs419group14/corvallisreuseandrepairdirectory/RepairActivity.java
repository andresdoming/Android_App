...
public class RepairActivity extends ListActivity {
    ...
    private static final String URL_CATS = "http://web.engr.oregonstate.edu/~izunot/CS419/android/categories.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            alert.showAlertDialog(RepairActivity.this, "Internet Connection Error",
        ...
        lv.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
                                    long arg3) {
                Intent i = new Intent(getApplicationContext(), RepairSubcategories.class);
    ...
    class LoadCategories extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            String json = jsonParser.makeHttpRequest(URL_CATS, "GET",
                    params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            RepairActivity.this, categoriesList,
